...
/**
 * @Author : ZhangYun
 * @Description :LengthFieldBasedFrameDecoder支持自动的TCP粘包和半包处理，只需要给出标识消息长度的字段偏移量和消息长度自身所占的字节数，Netty就能自动实现对半包的处理。
 * @Date :  2017/8/2.
 */
public class NettyMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        if(frame == null){//如果为空说明是个半包消息，直接返回继续由I/O线程读取后续的码流。
            return null;
        }
